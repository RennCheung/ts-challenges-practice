...
type cases1 = [
  // @ts-expect-error
  Expect<Equal<DropChar1<"butter fly!", "">, "butterfly!">>,
  Expect<Equal<DropChar1<"butter fly!", " ">, "butterfly!">>,
  Expect<Equal<DropChar1<"butter fly!", "!">, "butter fly">>,
  Expect<Equal<DropChar1<"    butter fly!        ", " ">, "butterfly!">>,
  Expect<Equal<DropChar1<" b u t t e r f l y ! ", " ">, "butterfly!">>,
  Expect<
    Equal<DropChar1<" b u t t e r f l y ! ", "b">, "  u t t e r f l y ! ">
  >,
  Expect<Equal<DropChar1<" b u t t e r f l y ! ", "t">, " b u   e r f l y ! ">>
];
